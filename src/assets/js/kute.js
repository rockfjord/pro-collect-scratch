...
!(function (t, e) {
    ...
    for (
        var t,
            e = "undefined" != typeof global ? global : window,
            n = e.performance,
            i = document.body,
            r = [],
            s = null,
            ...
            y = ["top", "left", "width", "height"],
            I = ["translate3d", "translateX", "translateY", "translateZ", "rotate", "translate", "rotateX", "rotateY", "rotateZ", "skewX", "skewY", "scale"],
            b = ["opacity"],
            M = w.concat(b, y, I),
            O = {},
            k = 0,
    ...
    var x = {
        ...
        Y = function (t, e) {
            var n;
            if (null === (n = e ? (t instanceof Object || "object" == typeof t ? t : document.querySelectorAll(t)) : "object" == typeof t ? t : document.querySelector(t)) && "window" !== t)
        ...
        F = function (t) {
            ...
            if (!/^#|^rgb/.test(t)) {
                ...
                return (
                    (a = /rgb/.test(a) ? a.replace(/[^\d,]/g, "")[o](",") : [0, 0, 0]),
                    (s[m].color = ""),
                    {
                        r: parseInt(a[0]),
                        g: parseInt(a[1]),
                    ...
                    if (/transform/i.test(e[i]))
                        for (var s = e[i][o](":")[1][o](")"), h = 0, c = s[a] - 1; h < c; h++) {
                            var l = s[h][o]("("),
                                f = l[0],
                                p = l[1];
                            -1 !== I[u](f) && (n[f] = /translate3d/.test(f) ? p[o](",") : p);
                        }
                return n;
            }
        },
        ...
        st = function () {
            var t = this[f],
                e = this[h];
            void 0 !== e.perspective && D in this[l] && (this[c][D].perspective = this[l][D].perspective),
                void 0 === e.transformOrigin || "svgTransform" in this[l] || (t[m][P("transformOrigin")] = e.transformOrigin),
                void 0 !== e.perspectiveOrigin && (t[m][P("perspectiveOrigin")] = e.perspectiveOrigin),
                void 0 !== e.parentPerspective && (t.parentNode[m][P("perspective")] = e.parentPerspective + "px"),
                void 0 !== e.parentPerspectiveOrigin && (t.parentNode[m][P("perspectiveOrigin")] = e.parentPerspectiveOrigin);
        },
        at = {},
        ot = {},
        ut = {
            boxModel: function (t, e) {
                t in nt ||
                    (nt[t] = function (t, e, n, i, r) {
                        t[m][e] = (r > 0.99 || r < 0.01 ? ((10 * K(n, i, r)) >> 0) / 10 : K(n, i, r) >> 0) + "px";
                    });
                var n = X(e),
            ...
            transform: function (t, e) {
                if (
                    (D in nt ||
                        (nt[D] = function (t, e, n, i, r, s) {
                            t[m][e] =
                                (n.perspective || "") +
                                ("translate" in n ? J(n.translate, i.translate, "px", r) : "") +
                                ("rotate" in n ? V(n.rotate, i.rotate, "deg", r) : "") +
                                ("skew" in n ? tt(n.skew, i.skew, "deg", r) : "") +
                                ("scale" in n ? et(n.scale, i.scale, r) : "");
                        }),
                    /translate/.test(t))
                ) {
                    if ("translate3d" === t) {
                    ...
                    if ("translate" === t) {
                        ...
                        return (
                            c instanceof Array
                                ? ((l.x = "%" === p.u ? (p.v * this[f].offsetWidth) / 100 : p.v), (l.y = "%" === v.u ? (v.v * this[f].offsetHeight) / 100 : v.v))
                                : ((h = X(c)), (l.x = "%" === h.u ? (h.v * this[f].offsetWidth) / 100 : h.v), (l.y = 0)),
                            l
                        );
                    }
        ...
        ht = function (t, e) {
            ...
            for (var o in t)
                if (-1 !== I[u](o)) {
                    ...
                    -1 !== y[u](o)
                        ? (n[o] = ut.boxModel.call(this, o, t[o]))
                        : -1 !== b[u](o) || "scroll" === o
                        ? (n[o] = ut.unitless.call(this, o, t[o]))
                        : -1 !== w[u](o)
                        ? (n[o] = ut.colors.call(this, o, t[o]))
                        : o in ut && (n[o] = ut[o].call(this, o, t[o]));
        },
        ct = function () {
            if (this[h][g])
                for (var t in this[l]) {
                ...
                if (-1 !== I[u](s)) {
                    ...
                    if (/translate/.test(s) && "translate" !== s) t.translate3d = n.translate3d || O[s];
                        ...
                        for (var o = 0; o < 2; o++)
                            for (var h = 0; h < 3; h++) {
                                var p = i[o] + r[h];
                                -1 !== I[u](p) && p in this[c] && (t[p] = n[p] || O[p]);
                            }
                } else if ("scroll" !== s)
                    if ("opacity" === s && L) {
    ...
    (mt.linear = function (t) {
        ...
        (mt.easingElasticIn = function (t) {
            var e,
                n = 0.1;
            return 0 === t ? 0 : 1 === t ? 1 : (!n || n < 1 ? ((n = 1), (e = 0.1)) : (e = ((0.4 * Math.asin(1 / n)) / Math.PI) * 2), -n * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * Math.PI * 2) / 0.4));
        }),
        (mt.easingElasticOut = function (t) {
            var e,
                n = 0.1;
            return 0 === t ? 0 : 1 === t ? 1 : (!n || n < 1 ? ((n = 1), (e = 0.1)) : (e = ((0.4 * Math.asin(1 / n)) / Math.PI) * 2), n * Math.pow(2, -10 * t) * Math.sin(((t - e) * Math.PI * 2) / 0.4) + 1);
        }),
        (mt.easingElasticInOut = function (t) {
            ...
            return 0 === t
                ...
                : 1 === t
                ? 1
                : (!n || n < 1 ? ((n = 1), (e = 0.1)) : (e = ((0.4 * Math.asin(1 / n)) / Math.PI) * 2),
                  (t *= 2) < 1 ? n * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * Math.PI * 2) / 0.4) * -0.5 : n * Math.pow(2, -10 * (t -= 1)) * Math.sin(((t - e) * Math.PI * 2) / 0.4) * 0.5 + 1);
        }),
        ...
        (mt.easingBounceInOut = function (t) {
            return t < 0.5 ? 0.5 * mt.easingBounceIn(2 * t) : 0.5 * mt.easingBounceOut(2 * t - 1) + 0.5;
        });
    var wt = function (t, e, n, i) {
            ...
            (this[h].chain = []),
                (this[h].easing = dt(i.easing) || mt[x.easing] || mt.linear),
                (this[h][v] = i[v] || x[v]),
                (this[h].repeatDelay = i.repeatDelay || x.repeatDelay),
                (this[h][g] = i[g] || x[g]),
                (this[h].duration = i.duration || x.duration),
                (this[h][p] = i[p] || x[p]),
                (this[v] = this[h][v]);
        },
        yt =
            ((wt.prototype = {
                start: function (t) {
                    ...
                    return (
                        ...
                        (this.paused = !1),
                        (this._startFired = !1),
                        (this._startTime = t || n.now()),
                        (this._startTime += this[h][p]),
                        this._startFired || (this[h].start && this[h].start.call(), (this._startFired = !0)),
                        !s && it(),
                        this
                    );
                },
    ...
    return (
        document.addEventListener(Q, ft, !1),
        document.addEventListener("mouseenter", ft, !1),
        {
            property: P,
            getPrefix: E,
            selector: Y,
